...
function setup(){
    ...
    */
    ...
    select.option('正二十面体');
    select.option('正二十面体２');
    select.option('正二十面体と長方形');
    select.option('正二十面体と長方形２');

    select.selected('正二十面体');
...
function draw(){    
    ...
    let list=[];
    if(select.value()=='正二十面体'||select.value()=='正二十面体２')    list=[0];
    if(select.value()=='正二十面体と長方形')    list=[0,1];
    if(select.value()=='正二十面体と長方形２')    list=[0,1,2,3];

    
    for(let k=0;k<list.length;k++)  for(let i=0;i<facenum[list[k]].length;i++){  
        strokeWeight(size/100);
        if(select.value()=='正二十面体'){
            fill(100,100,255);
            stroke(0);
        }

        if(select.value()=='正二十面体２'){
            noFill();
            stroke(0);
        }

        if(select.value()=='正二十面体と長方形'||select.value()=='正二十面体と長方形２'){
            if(k==0){
                noFill();
                stroke(0);
            }
        ...
        if((select.value()=='正二十面体２'||select.value()=='正二十面体と長方形'||select.value()=='正二十面体と長方形２')&&k==0){
            stroke(255);
